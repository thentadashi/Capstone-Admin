<?php
		...
		<div class="row">
        	...
        	<!-- /.col-lg-12 -->
				...
				<table id="dash-table"  class="table table-striped"  style="font-size:12px;" cellspacing="0" >
					
				  <thead>
				  	<tr> 
				  		<th width="1%">#</th>
				  		<th width="5%"><p style="color: #6c7293;">Image</p></th>
				  		<!-- <th>Model</th>  -->
				  		<!-- <th align="left"><input type="checkbox" name="chkall" id="chkall" onclick="return checkall('selector[]');"> Product</th>  -->
				  		<th width="10%"><p style="color: #6c7293;">Product</p></th> 
				  		<th width="10%"><p style="color: #6c7293;">Description</p></th>
				  		<!-- <th>Category</th> -->
				  		<th width="10%"><p style="color: #6c7293;">Price</p></th>
				  		<th width="10%"><p style="color: #6c7293;">Discount%</p></th>  
				  		<th width="10%"><p style="color: #6c7293;">Discounted Price</p></th>  
			  ...
			  <tbody>
				    ...
				    echo '<td style="padding:0px;">
							...
							<img  title="'.$result->CATEGORIES.'" style="width:70px;height:70px;padding:10px;"  src="'. web_root.'admin/products/'.$result->IMAGES . '">
							</a></td>'; 	
				  		...
				  		echo '<td><p><a title="edit" href="'.web_root.'admin/products/index.php?view=edit&id='.$result->PROID.'" style=" color: #6c7293;font-size:20px;"><i class="fa fa-pencil "></i>'.$result->CATEGORIES.'</a></p></td>';
