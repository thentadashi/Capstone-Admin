        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <h2 ><a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" ><p style="font-size: 23px;color: #f2f2f2;padding-left:53px;" ><b>IT MAN</b></p></a></h2>
...
?> 
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                            ...
                            <p style="padding-left: 10px;color: #f2f2f2;"> 
                                <img title="profile image" width="70" height="70" style="border-radius: 45px;"src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>"> <span style="position: absolute;
    left: 23%;
    width: 15px;
    height: 15px;
    ...
    line-height: 2.7;
    top: 52px;
    border: 2px solid #2c2e33;"></span> <?php echo $_SESSION['U_NAME']; ?> 
  ...
  <div id="page-wrapper" style="background-color: #;">
            ...
            <div class="row" >
                ...
                <div class="col-lg-12"> 
                    ...
                    <?php 
                    if ($title<>'Dashboard'){
                       echo   '<p class="breadcrumb" style="margin-top: 25px;background-color:#191c24;"> 
                        <a style=" color: #ffab00;" href="index.php" title="'. $title.'" >'. $title.'</a> 
                  ...
                  <?php require_once $content; ?>
                       ...
                       <!-- /.col-lg-12 -->
                                              <img class="" style="margin-top: 30px; margin: 50px;" src="<?php echo web_root.'admin/images/itmanlg.png' ?>" />
            </div>
            <!-- /.row -->
