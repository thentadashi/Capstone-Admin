...
<div class="col-md-3 Cus-info">

<div class="header">Customer Information</div> 
                 <img src="<?php echo web_root. 'customer/'. $res->CUSPHOTO; ?>" Height="100px" width="100px"/> 
  <div class="row">

    <div class="col-md-12">
        <div class="col-md-6">
                       <h3><strong>First Name</strong></h3>
            <label style="color: #0f6400;"><?php echo $res->FNAME; ?></label>
        </div>
        <div class="col-md-6">
                       <h3><strong>Last Name</strong></h3>
            <label style="color: #0f6400;"><?php echo $res->LNAME; ?></label>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="col-md-6">
            ...
            <label style="color: #0f6400;"><?php echo $res->GENDER; ?></label>
        </div>
        <div class="col-md-6">
                       <h3><strong>Phone</strong></h3>
            <label style="color: #0f6400;"><?php echo $res->PHONE; ?><br></label>
        </div>
                <div class="col-md-12">
                       <h3><strong>Email Address</strong></h3>
            <label style="color: #0f6400;"><?php echo $res->EMAILADD; ?></label>
        </div>

                        <div class="col-md-12">
                       <h3><strong>Status</strong></h3>
            <label style="color: #0f6400;"><?php echo $res->status; ?></label>
        </div>
    </div>
